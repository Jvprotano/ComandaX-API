...
3. **GraphQL Optimization**: Use DataLoaders to prevent N+1 queries
4. **Immutability**: Use records for DTOs, private setters for entities
5. **Dependency Injection**: Constructor injection throughout
6. **Clean Code**: Follow consistent naming and patterns
7. **Type Safety**: Leverage C# type system and nullable reference types
